  ...
  return (
    <>
      <InputCustom
        ...
        placeholder="Địa chỉ"
        keyInput="address"
        defaultValue={dateProfileCamelCase["address"]}
      />
      <SelectAutocomplete
        label={
        ...
        defaultSelectedKey={dateProfileCamelCase["province"]}
      />
      <SelectAutocomplete
        label={
          <div className="flex gap-1 text-small font-medium text-foreground pb-1.5">
        ...
        defaultSelectedKey={dateProfileCamelCase["district"]}
      />
      <SelectAutocomplete
        label={
          <div className="flex gap-1 text-small font-medium text-foreground pb-1.5">
        ...
        defaultSelectedKey={dateProfileCamelCase["ward"]}
      />
    </>
  );
};
