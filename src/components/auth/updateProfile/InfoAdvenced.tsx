...
const InfoAdvenced = ({ register, errors, setValue, dateProfileCamelCase }) => {
  return (
    <>
      <InputCustom
        label="Chiều cao"
      ...
      <RadioCustom
        ...
        errors={errors}
        setValue={setValue}
        defaultValue={dateProfileCamelCase["genderId"]}
      />
      <RadioCustom
        className="mb-5"
        labelRadio={
        ...
        errors={errors}
        setValue={setValue}
        defaultValue={dateProfileCamelCase["backHandId"]}
      />
    </>
  );
};
